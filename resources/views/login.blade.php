...
<center> <form action="register.php" method="post">
        ...
        <input id = "us1" class="inputtext" type="text" name="username" id="username" placeholder="Username"><br>
        <!--            <label class = "pasword" for="password">Password:</label>-->
        <input id="pas2" class ="inputpas1" type="password"  name="password" id="password" placeholder="Password"><br>
        <!--            <label  class = "cpasword" for="confirm_password">Confirm Password:</label>-->
        <input id="pas2" class ="inputpas2" type="password"  name="confirm_password" id="confirm_password" placeholder="Confirm Password"><br>
        <button id="main_div" class="button" type="submit" >Sign in</button><br>
        <a id="regbut" class ="fancy"href="welcome.blade.php"">Register</a>
        <a id ="logbut" class="fancy2" href="login.php">Login</a>
</form>
<style>
    .fancy {
